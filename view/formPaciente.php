			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<div class="card card-primary">
						...
						<!-- /.card-header -->
						<form name="cadastroPaciente" id="cadastroPaciente" method="post"
							...
							<div class="card-body">
								...
								<div class="row form-group">
									<div class="col-md-3 form-group">
										...
										<input maxlength="50" type="text" class="form-control" name="itEmail" id="itEmail"
											...
											value="<?php echo $PessoaDTO->getEmail(); ?>">
									</div>
									<div class="col-md-2 form-group">
								...
								<div class="alert alert-info alert-dismissible fade show" role="alert" style="padding: 7px; font-size: 15px; text-align: center; <?php if($tipoPessoa == 3) echo " display: none;"; ?>">
        							O CPF será o login e a senha do paciente! (Somente números)
        						</div>
							</div>
...
<script>
	...
	$(document).ready(function() {
		<?php
			if($tipoPessoa == 3){
				echo " $('#itNome,#itEmail,#itCpf').css('pointer-events','none'); ";
			}
		?>
  	});
	...
	$(function() {
		...
		messages: {
			...
			itCns: { cnsValido: "Informe um CNS válido!"},
			itEmail: { 
