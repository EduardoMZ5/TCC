            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Registros cadastrados</h3>
                  <a href="../view/formAdministrador.php?action=insert">
                    <button type="button" class="btn btn-primary float-right" >
                      <i class="fas fa-plus"></i></i>  Incluir Administrador
                    </button>
                  </a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="administrador" class="table table-bordered table-striped">
                  <thead>
                  <tr>
                    <th>#</th>
                    <th>Nome</th>
                    ...
                    if (isset($resultSet)){
				          	  ...
				          	  foreach ($resultSet as $PessoaDTO) {
				          	  	...
				          	  	echo '<tr>
				          	  			  	...
				          	  			  	<td>
                                  <a style="color: black;" href="../controller/PessoaController.php?action=view&id='. $PessoaDTO->getIdPessoa() .'&tipoPessoa=1"><i title="Visualizar registro" style="cursor: pointer; margin-right: 10px;" class="fas fa-eye"></i></a>
                                  <a style="color: black;" href="../controller/PessoaController.php?action=edit&id='. $PessoaDTO->getIdPessoa() .'&tipoPessoa=1"><i title="Alterar registro" style="cursor: pointer; margin-right: 10px;" class="fas fa-pencil-alt"></i></a>
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <form name="deletePaciente" id="deletePaciente" method="get" action="../controller/PessoaController.php">
            ...
            <input type="hidden" id="tipoPessoa" name="tipoPessoa" value="1">
